...
try:
    ...
    layered(1, range(len(df3)), 1, df3.Supplier, '#51545b', 0.7,
            df_group_port.Ship)
    layered(2, df_group_ship.Ship, -1, df4.Port, '#00B398', 1,
            df_group_port.Ship)
    ...
    plt.legend(handles=[port_col, supp_col], pos=topright)
...
#colorImage = Image.open("plots/PPTPortSupplier.png")
## Rotate it by 90 degrees
#transposed = colorImage.transpose(Image.ROTATE_270)
#transposed.save(u.full_path('plots', 'PPTPortSupplier.png'))
