with port_suppliers as (
  SELECT port_id, 
   ...
   WHERE clients.name ~* 'Anthony Veder Rederijzaken B.V.' 
     and 
     samples.validated_on::date between '2016-10-01' AND '2017-09-30'
...
all_samples as (
   ...
   where samples.job_id is not null
     ...
     AND samples.validated_on::DATE between  '2012-10-01' AND '2017-09-30'
     ...
     AND clients.name ~* 'Anthony Veder Rederijzaken B.V.' 
)
select 
case when "V50_Remark" =  'AMBER' then count ("V50_Remark") else 0 end as "V50_Remark_a",
case when "V50_Remark" =  'RED' then count ("V50_Remark") else 0 end as "V50_Remark_r",
case when "Tested_Den_Remark" =  'AMBER' then count ("Tested_Den_Remark") else 0 end as "Tested_Den_Remark_a",
case when "Tested_Den_Remark" =  'RED' then count ("Tested_Den_Remark") else 0 end as "Tested_Den_Remark_r",
case when "Water_Remark" =  'AMBER' then count ("Water_Remark") else 0 end as "Water_Remark_a",
case when "Water_Remark" =  'RED' then count ("Water_Remark") else 0 end as "Water_Remark_r",
case when "MCR_Remark" =  'AMBER' then count ("MCR_Remark") else 0 end as "MCR_Remark_a",
case when "MCR_Remark" =  'RED' then count ("MCR_Remark") else 0 end as "MCR_Remark_r",
case when "Sediment_Remark" =  'AMBER' then count ("Sediment_Remark") else 0 end as "Sediment_Remark_a",
case when "Sediment_Remark" =  'RED' then count ("Sediment_Remark") else 0 end as "Sediment_Remark_r",
case when "Sulphur_low_Remark" =  'AMBER' then count ("Sulphur_low_Remark") else 0 end as "Sulphur_low_Remark_a",
case when "Sulphur_low_Remark" =  'RED' then count ("Sulphur_low_Remark") else 0 end as "Sulphur_low_Remark_r",
case when "Sulphur_high_Remark" =  'AMBER' then count ("Sulphur_high_Remark") else 0 end as "Sulphur_high_Remark_a",
case when "Sulphur_high_Remark" =  'RED' then count ("Sulphur_high_Remark") else 0 end as "Sulphur_high_Remark_r",
case when "PPT_Remark" =  'AMBER' then count ("PPT_Remark") else 0 end as "PPT_Remark_a",
case when "PPT_Remark" =  'RED' then count ("PPT_Remark") else 0 end as "PPT_Remark_r",
case when "Fpt_Remark" =  'AMBER' then count ("Fpt_Remark") else 0 end as "Fpt_Remark_a",
case when "Fpt_Remark" =  'RED' then count ("Fpt_Remark") else 0 end as "Fpt_Remark_r",
case when "CCAI_Remark" =  'AMBER' then count ("CCAI_Remark") else 0 end as "CCAI_Remark_a",
case when "CCAI_Remark" =  'RED' then count ("CCAI_Remark") else 0 end as "CCAI_Remark_r",
case when "V_Remark" =  'AMBER' then count ("V_Remark") else 0 end as "V_Remark_a",
case when "V_Remark" =  'RED' then count ("V_Remark") else 0 end as "V_Remark_r",
case when "Na_Remark" =  'AMBER' then count ("Na_Remark") else 0 end as "Na_Remark_a",
case when "Na_Remark" =  'RED' then count ("Na_Remark") else 0 end as "Na_Remark_r",
case when "TAN_Remark" =  'AMBER' then count ("TAN_Remark") else 0 end as "TAN_Remark_a",
case when "TAN_Remark" =  'RED' then count ("TAN_Remark") else 0 end as "TAN_Remark_r",
case when "AlSi_Remark" =  'AMBER' then count ("AlSi_Remark") else 0 end as "AlSi_Remark_a",
case when "AlSi_Remark" =  'RED' then count ("AlSi_Remark") else 0 end as "AlSi_Remark_r",
case when "ULO_Remark" =  'AMBER' then count ("ULO_Remark") else 0 end as "ULO_Remark_a",
case when "ULO_Remark" =  'RED' then count ("ULO_Remark") else 0 end as "ULO_Remark_r",
case when "CI_Remark" =  'AMBER' then count ("CI_Remark") else 0 end as "CI_Remark_a",
case when "CI_Remark" =  'RED' then count ("CI_Remark") else 0 end as "CI_Remark_r",
case when "CFPP_Remark" =  'AMBER' then count ("CFPP_Remark") else 0 end as "CFPP_Remark_a",
case when "CFPP_Remark" =  'RED' then count ("CFPP_Remark") else 0 end as "CFPP_Remark_r",
case when "V40_Remark" =  'AMBER' then count ("V40_Remark") else 0 end as "V40_Remark_a",
case when "V40_Remark" =  'RED' then count ("V40_Remark") else 0 end as "V40_Remark_r",
case when "HFRR_Remark" =  'AMBER' then count ("HFRR_Remark") else 0 end as "HFRR_Remark_a",
case when "HFRR_Remark" =  'RED' then count ("HFRR_Remark") else 0 end as "HFRR_Remark_r",
case when "V40_Remark_LT_3" =  'AMBER' then count ("V40_Remark_LT_3") else 0 end as "V40_Remark_LT_3_a",
case when "V40_Remark_LT_3" =  'RED' then count ("V40_Remark_LT_3") else 0 end as "V40_Remark_LT_3_r",
case when "Sulphur_LT_005" =  'AMBER' then count ("Sulphur_LT_005") else 0 end as "Sulphur_LT_005_a",
case when "Sulphur_LT_005" =  'RED' then count ("Sulphur_LT_005") else 0 end as "Sulphur_LT_005_r",
case when "MCR10_Remark" =  'AMBER' then count ("MCR10_Remark") else 0 end as "MCR10_Remark_a",
...
left outer join iso_8217_2012_limits on iso_8217_2012_limits.grade = substr(template_name,1,6)
...
join lateral (select f_r_s('FM9990.00', all_samples.id, ARRAY[158, 370, 34, 164, 163]) as "V40_Result", 
                     ...
                     coalesce(nullif(f_r_s('FM9990.00', all_samples.id, ARRAY[352,8,270,269,267,266,268,351, 271, 272]), '0.00'), '0.05') as "Water_Result",
                     ...
                     f_r_s('FM9990', all_samples.id, ARRAY[12]) as "CFPP_Result",
                     ...
                     coalesce(f_r_s('FM9990.00', all_samples.id, ARRAY[258, 353, 257, 259, 313]),f_r_s('FM9990.00', all_samples.id, ARRAY[250, 261, 361, 249, 248, 257, 313, 353, 258, 6, 259])) as "Sediment",
...
join lateral (select 
                     test_limits(to_number("V50_Result", 'FM9990.00'), kv_50_l, kv_50__95) as "V50_Remark",
                     test_limits(Density_15C.final_value, den15_l, den15__95) as "Tested_Den_Remark",
                     test_limits(to_number("Water_Result", 'FM9990.00'), water_l, water__95) as "Water_Remark",
		     test_limits(to_number("MCR_Result", 'FM9990.00'), mcr_l, mcr__95) as "MCR_Remark",
		     case when to_number("Sediment", 'FM9990.00') <= 0.1 then 'GREEN'
		     when to_number("Sediment", 'FM9990.00') > 0.1 and  to_number("Sediment", 'FM9990.00') <= 0.15 then 'AMBER'
		     when to_number("Sediment", 'FM9990.00') > 0.15 then 'RED' END as "Sediment_Remark",

			case when all_samples.sulphur_level = 'LOW' and to_number(final_string('FM9990.00', result_for(all_samples.id, ARRAY[231,232,358,234,33,235,233])), 'FM9990.00') > iso_8217_2012_limits.slow_l 
			and to_number(final_string('FM9990.00', result_for(all_samples.id, ARRAY[231,232,358,234,33,235,233])), 'FM9990.00') <= iso_8217_2012_limits.slow__95 
			then 'AMBER'
			when all_samples.sulphur_level = 'LOW' and to_number(final_string('FM9990.00', result_for(all_samples.id, ARRAY[231,232,358,234,33,235,233])), 'FM9990.00') > iso_8217_2012_limits.slow__95 
			then 'RED' 
			when all_samples.sulphur_level = 'LOW' and to_number(final_string('FM9990.00', result_for(all_samples.id, ARRAY[231,232,358,234,33,235,233])), 'FM9990.00') <= iso_8217_2012_limits.slow_l then 'GREEN'
			else 'OTHER'
			end as "Sulphur_low_Remark",			

			case when all_samples.sulphur_level = 'HIGH' and to_number(final_string('FM9990.00', result_for(all_samples.id, ARRAY[231,232,358,234,33,235,233])),'FM9990.00') > iso_8217_2012_limits.shigh_l 
			and to_number(final_string('FM9990.00', result_for(all_samples.id, ARRAY[231,232,358,234,33,235,233])), 'FM9990.00') <= iso_8217_2012_limits.shigh__95 
			then 'AMBER'
			when all_samples.sulphur_level = 'HIGH' and to_number(final_string('FM9990.00', result_for(all_samples.id, ARRAY[231,232,358,234,33,235,233])),'FM9990.00') > iso_8217_2012_limits.shigh__95 
			then 'RED' 
			when all_samples.sulphur_level = 'HIGH' and to_number(final_string('FM9990.00', result_for(all_samples.id, ARRAY[231,232,358,234,33,235,233])),'FM9990.00') <= iso_8217_2012_limits.shigh_l then 'GREEN'
			else 'OTHER'
			end as "Sulphur_high_Remark",
			
                     test_limits(to_number("PPT_Result", 'FM9990.00'),  ppt_l, ppt__95) as "PPT_Remark",  
                     case when to_number("Fpt_Result", 'FM9990.00') < 60 then 'RED' else 'GREEN' end as "Fpt_Remark",                                       
                     test_limits(to_number("CCAI_Result", 'FM9990.00'), ccai_l, ccai__95) as "CCAI_Remark",
 		     test_limits(to_number("V_Result", 'FM9990'), v_l, v__95) as "V_Remark",                    
		     test_limits(to_number("Na_Result", 'FM9990'), na_l, na_95) as "Na_Remark",                     
		     test_limits(to_number("TAN_Result", 'FM9990.00'), an_l, an_95) as "TAN_Remark",
 		     test_limits(to_number("AlSi_Result", 'FM9990'), alsi_l, alsi_95) as "AlSi_Remark",                 
		     ...
		     test_cetane_limits(to_number("CI_Result", 'FM9990'), 40, 35) as "CI_Remark",		     
                     ...
                     case when "CFPP_Result" = 'Unobtainable' then 'RED'
                     when to_number(final_string('FM9990', result_for(all_samples.id, ARRAY[12])), 'FM9990') < 10 then 'GREEN'
                     when to_number(final_string('FM9990', result_for(all_samples.id, ARRAY[12])), 'FM9990') >= 10 and
                     to_number(final_string('FM9990', result_for(all_samples.id, ARRAY[12])), 'FM9990') <= 20 then 'AMBER'
                     when to_number(final_string('FM9990', result_for(all_samples.id, ARRAY[12])), 'FM9990') > 20 then 'RED' 
                     else 'OTHER'
                     end as "CFPP_Remark",
                     
		     test_limits(to_number("V40_Result", 'FM9990.00'), kv_40h_l, kv_40h_95) as "V40_Remark",
		     test_limits(to_number("HFRR_Result", 'FM9990'), hfrr_l, hfrr__95) as "HFRR_Remark",		     		     
			...
			and to_number(final_string('FM9990.00',  result_for(all_samples.id, ARRAY[158, 370, 34, 164, 163])), 'FM9990.00') <= 3 
		     ...
		     test_limits(to_number("MCR10_Result", 'FM9990.00'), mcr_10_l, mcr_10__95) as "MCR10_Remark"
                ) remarks on true
group by 
"Tested_Den_Remark", 
"V50_Remark", 
