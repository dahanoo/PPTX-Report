...
select
all_samples.port_name,
all_samples.supplier_name, 
...
case when "Tested_Den_Remark" =  'AMBER' then count ("Tested_Den_Remark") else 0 end as "Den_a",
case when "Tested_Den_Remark" =  'RED' then count ("Tested_Den_Remark") else 0 end as "Den_r",
...
case when "Sediment_Remark" =  'AMBER' then count ("Sediment_Remark") else 0 end as "Sed_a",
case when "Sediment_Remark" =  'RED' then count ("Sediment_Remark") else 0 end as "Sed_r",
case when "Sulphur_low_Remark" =  'AMBER' then count ("Sulphur_low_Remark") else 0 end as "S low_a",
case when "Sulphur_low_Remark" =  'RED' then count ("Sulphur_low_Remark") else 0 end as "S low_r",
case when "Sulphur_high_Remark" =  'AMBER' then count ("Sulphur_high_Remark") else 0 end as "S high_a",
case when "Sulphur_high_Remark" =  'RED' then count ("Sulphur_high_Remark") else 0 end as "S high_r",
...
case when "V_Remark" =  'AMBER' then count ("V_Remark") else 0 end as "V_a",
case when "V_Remark" =  'RED' then count ("V_Remark") else 0 end as "V_r",
case when "Na_Remark" =  'AMBER' then count ("Na_Remark") else 0 end as "Na_a",
case when "Na_Remark" =  'RED' then count ("Na_Remark") else 0 end as "Na_r",
...
case when "V40_Remark_LT_3" =  'AMBER' then count ("V40_Remark_LT_3") else 0 end as "V40 < 3_a",
case when "V40_Remark_LT_3" =  'RED' then count ("V40_Remark_LT_3") else 0 end as "V40 < 3_r",
case when "Sulphur_LT_005" =  'AMBER' then count ("Sulphur_LT_005") else 0 end as "Sul < 0.05_a",
case when "Sulphur_LT_005" =  'RED' then count ("Sulphur_LT_005") else 0 end as "Sul < 0.05_r",
