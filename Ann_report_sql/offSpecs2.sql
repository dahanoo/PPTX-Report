...
select
--all_samples.fuel_type_id,
case when "V50_Remark" =  'AMBER' then count ("V50_Remark") else 0 end as "V50_a",
case when "V50_Remark" =  'RED' then count ("V50_Remark") else 0 end as "V50_r",
case when "Tested_Den_Remark" =  'AMBER' then count ("Tested_Den_Remark") else 0 end as "Density_a",
case when "Tested_Den_Remark" =  'RED' then count ("Tested_Den_Remark") else 0 end as "Density_r",
case when "Water_Remark" =  'AMBER' then count ("Water_Remark") else 0 end as "Water_a",
case when "Water_Remark" =  'RED' then count ("Water_Remark") else 0 end as "Water_r",
case when "MCR_Remark" =  'AMBER' then count ("MCR_Remark") else 0 end as "MCR_a",
case when "MCR_Remark" =  'RED' then count ("MCR_Remark") else 0 end as "MCR_r",
case when "Sediment_Remark" =  'AMBER' then count ("Sediment_Remark") else 0 end as "Sediment_a",
case when "Sediment_Remark" =  'RED' then count ("Sediment_Remark") else 0 end as "Sediment_r",
case when "Sulphur_low_Remark" =  'AMBER' then count ("Sulphur_low_Remark") else 0 end as "Sulphur low_a",
case when "Sulphur_low_Remark" =  'RED' then count ("Sulphur_low_Remark") else 0 end as "Sulphur low_r",
case when "Sulphur_high_Remark" =  'AMBER' then count ("Sulphur_high_Remark") else 0 end as "Sulphur high_a",
case when "Sulphur_high_Remark" =  'RED' then count ("Sulphur_high_Remark") else 0 end as "Sulphur high_r",
case when "PPT_Remark" =  'AMBER' then count ("PPT_Remark") else 0 end as "PPT_a",
case when "PPT_Remark" =  'RED' then count ("PPT_Remark") else 0 end as "PPT_r",
case when "Fpt_Remark" =  'AMBER' then count ("Fpt_Remark") else 0 end as "Fpt_a",
case when "Fpt_Remark" =  'RED' then count ("Fpt_Remark") else 0 end as "Fpt_r",
case when "CCAI_Remark" =  'AMBER' then count ("CCAI_Remark") else 0 end as "CCAI_a",
case when "CCAI_Remark" =  'RED' then count ("CCAI_Remark") else 0 end as "CCAI_r",
case when "V_Remark" =  'AMBER' then count ("V_Remark") else 0 end as "Vanadium_a",
case when "V_Remark" =  'RED' then count ("V_Remark") else 0 end as "Vanadium_r",
case when "Na_Remark" =  'AMBER' then count ("Na_Remark") else 0 end as "Sodium_a",
case when "Na_Remark" =  'RED' then count ("Na_Remark") else 0 end as "Sodium_r",
case when "TAN_Remark" =  'AMBER' then count ("TAN_Remark") else 0 end as "TAN_a",
case when "TAN_Remark" =  'RED' then count ("TAN_Remark") else 0 end as "TAN_r",
case when "AlSi_Remark" =  'AMBER' then count ("AlSi_Remark") else 0 end as "AlSi_a",
case when "AlSi_Remark" =  'RED' then count ("AlSi_Remark") else 0 end as "AlSi_r",
case when "ULO_Remark" =  'AMBER' then count ("ULO_Remark") else 0 end as "ULO_a",
case when "ULO_Remark" =  'RED' then count ("ULO_Remark") else 0 end as "ULO_r",
case when "CI_Remark" =  'AMBER' then count ("CI_Remark") else 0 end as "CI_a",
case when "CI_Remark" =  'RED' then count ("CI_Remark") else 0 end as "CI_r",
case when "CFPP_Remark" =  'AMBER' then count ("CFPP_Remark") else 0 end as "CFPP_a",
case when "CFPP_Remark" =  'RED' then count ("CFPP_Remark") else 0 end as "CFPP_r",
case when "V40_Remark" =  'AMBER' then count ("V40_Remark") else 0 end as "V40_a",
case when "V40_Remark" =  'RED' then count ("V40_Remark") else 0 end as "V40_r",
case when "HFRR_Remark" =  'AMBER' then count ("HFRR_Remark") else 0 end as "HFRR_a",
case when "HFRR_Remark" =  'RED' then count ("HFRR_Remark") else 0 end as "HFRR_r",
case when "V40_Remark_LT_3" =  'AMBER' then count ("V40_Remark_LT_3") else 0 end as "V40 LT 3_a",
case when "V40_Remark_LT_3" =  'RED' then count ("V40_Remark_LT_3") else 0 end as "V40 LT 3_r",
case when "Sulphur_LT_005" =  'AMBER' then count ("Sulphur_LT_005") else 0 end as "Sulphur LT 0.05_a",
case when "Sulphur_LT_005" =  'RED' then count ("Sulphur_LT_005") else 0 end as "Sulphur LT 0.05_r",
case when "MCR10_Remark" =  'AMBER' then count ("MCR10_Remark") else 0 end as "MCR10_a",
case when "MCR10_Remark" =  'RED' then count ("MCR10_Remark") else 0 end as "MCR10_r"
from all_samples
