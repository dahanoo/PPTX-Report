...
with port_suppliers as (
  SELECT port_id, 
          supplier_id, 
          CASE when ports."name" != '' THEN initcap (replace (ports."name",',','')) ELSE 'N/S' END as port_name,
          CASE when suppliers."name" != '' THEN UPPER(replace (suppliers."name",',','')) ELSE 'N/S' END as supplier_name,
          CASE when countries."name" != '' THEN replace (countries."name",',','') ELSE 'N/S' END as country_name
